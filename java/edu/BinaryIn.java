...
public final class BinaryIn {
     ...
     */
    public BinaryIn() { in = new BufferedInputStream(System.in);
        fillBuffer();
    }
     ...
     */
    public BinaryIn(InputStream is) { in = new BufferedInputStream(is);
        fillBuffer();
    }
    ...
    public BinaryIn(Socket socket) {
        try {
            InputStream is = socket.getInputStream(); in = new BufferedInputStream(is);
            fillBuffer();
    ...
    public BinaryIn(URL url) {
        try {
            ...
            InputStream is = site.getInputStream(); in = new BufferedInputStream(is);
            fillBuffer();
        } catch (IOException ioe) {
    ...
    public BinaryIn(String name) {
        ...
        try {
            ...
            if (file.exists()) {
                FileInputStream fis = new FileInputStream(file); in = new BufferedInputStream(fis);
                fillBuffer();
                return;
            }
